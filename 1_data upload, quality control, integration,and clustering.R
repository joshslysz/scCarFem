...
### END QUALITY CONTROL ON SEPARATE SAMPLES ###
...
Carotid_Femoral_srt.int <- RunUMAP(Carotid_Femoral_srt.int, reduction = "harmony", dims = 1:20)
DimPlot(Carotid_Femoral_srt.int, reduction = "umap", group.by = "orig.ident")

# Find nearest neighbors and construct the graph
Carotid_Femoral_srt.int <- FindNeighbors(Carotid_Femoral_srt.int, dims = 1:20)
# Find the clusters
Carotid_Femoral_srt.int <- FindClusters(Carotid_Femoral_srt.int, resolution = 0.35)
